...
dataset_path = os.path.abspath("../notebooks/sample_datasets")
...
def main():
    ...
    with open(os.path.join(dataset_path, 'titles.csv'), 'w') as f:
        output = csv.writer(f)
    ...
    output = csv.writer(open(os.path.join(dataset_path, 'release_dates.csv'), 'w'))
    ...
    output = csv.writer(open(os.path.join(dataset_path, 'cast.csv'), 'w'))
